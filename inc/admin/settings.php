...
function aca_footer_logo(){
    ...
    echo '<input type="button" value="Upload Logo" id="upload_footer_logo_button" class="button button-secondary" /><input type="hidden" name="aca_footer_logo" value="'.$value.'" />';
}
